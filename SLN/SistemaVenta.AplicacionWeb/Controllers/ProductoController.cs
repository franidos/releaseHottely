...
namespace SistemaVenta.AplicacionWeb.Controllers
{
    ...
    public class ProductoController : Controller
    {
        ...
        public async Task<IActionResult> Lista()
        {
            ...
            List<ProductoDTO> productoDTOLista = _mapper.Map<List<ProductoDTO>>(await _productoService.Listar(idEstablishment));
        ...
        public async Task<IActionResult> Crear([FromForm] IFormFile imagen,[FromForm]string modelo)
        {
            ...
            try
            {
                ...
                productoDto.IdEstablishment = int.Parse(((ClaimsIdentity)claimUser.Identity).FindFirst("IdCompany").Value); 
