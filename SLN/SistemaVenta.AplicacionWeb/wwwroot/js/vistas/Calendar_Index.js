    ...
    swal({
        ...
        function (respuesta) {
            if (respuesta) {
                ...
                var adelantoText = $("#Adelanto").val();
                var totalRoomSpanText = $("#totalRoomSpan").text();
                movement.Total = parseFloat(totalRoomSpanText.replace(/[^\d.-]/g, ""));
                movement.AbonoReserva = parseFloat(adelantoText.replace(/[^\d.-]/g, ""));
