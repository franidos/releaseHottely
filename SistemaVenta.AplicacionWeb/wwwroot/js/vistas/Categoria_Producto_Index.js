...
function MostrarModal(modelo = MODELO_BASE) {
    ...
    $("#txtNombreCategoria").val(modelo.nombreCategoria);
...
$("#btnGuardar").click(function () {
    ...
    if ($("#txtNombreCategoria").val().trim() == "") {
        toastr.warning("", "Debes completar el campo: Nombre Categoria");
    ...
    modelo["nombreCategoria"] = $("#txtNombreCategoria").val();
...
$("#tbdata tbody").on("click", ".btn-eliminar", function () {
    ...
    swal({
        title: "¿Está seguro?",
        text: `Eliminar la Categoria "${data.nombreCategoria}"`,
        type: "warning",
